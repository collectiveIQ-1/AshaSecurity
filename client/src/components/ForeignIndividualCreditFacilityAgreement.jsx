...
export default function ForeignIndividualCreditFacilityAgreement({
  form,
  update,
  busy,
  onPrev,
  ...
  const cf = form?.fiClientRegistration?.creditFacility || {};
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-3xl border border-zinc-200 bg-white p-8 dark:border-zinc-800 dark:bg-zinc-950/60">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-x-3 gap-y-3 text-sm text-zinc-700 dark:text-zinc-200/90">
          ...
          <InlineInput
            value={date.day}
            onChange={(v) => update("fiClientRegistration.creditFacility.date.day", v)}
            placeholder="Date"
            disabled={busy}
            className="w-28"
          />
          ...
          <InlineInput
            value={date.month}
            onChange={(v) => update("fiClientRegistration.creditFacility.date.month", v)}
            placeholder="Month"
            disabled={busy}
            className="w-40"
          />
          ...
          <InlineInput
            value={date.year}
            onChange={(v) => update("fiClientRegistration.creditFacility.date.year", v)}
            placeholder="Year"
            disabled={busy}
            className="w-28"
          />
        ...
        <div className="mt-8">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-3 text-xs text-zinc-700 dark:text-zinc-200/90">
            <InlineInput
              value={client.name}
              onChange={(v) => update("fiClientRegistration.creditFacility.client.name", v)}
            ...
            <InlineInput
              value={client.nicCds}
              onChange={(v) => update("fiClientRegistration.creditFacility.client.nicCds", v)}
          ...
          <div className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-2 text-xs text-zinc-700 dark:text-zinc-200/90">
            ...
            <InlineInput
              ...
              onChange={(v) => update("fiClientRegistration.creditFacility.client.address", v)}
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-2 text-xs text-zinc-700 dark:text-zinc-200/90">
            ...
            <InlineInput
              ...
              onChange={(v) => update("fiClientRegistration.creditFacility.client.includeTheSaid", v)}
              placeholder=""
              disabled={busy}
              className="w-80"
            />
        ...
        <div className="mt-3 flex items-center gap-3">
          <InlineInput
            value={exec.name}
            onChange={(v) => update("fiClientRegistration.creditFacility.execution.name", v)}
            placeholder=""
            disabled={busy}
            className="w-full"
          />
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3 text-xs text-zinc-700 dark:text-zinc-200/90">
          ...
          <InlineInput
            value={exec.date}
            onChange={(v) => update("fiClientRegistration.creditFacility.execution.date", v)}
            placeholder="Date"
            disabled={busy}
            className="w-24"
          />
          ...
          <InlineInput
            value={exec.month}
            onChange={(v) => update("fiClientRegistration.creditFacility.execution.month", v)}
            placeholder="Month"
            disabled={busy}
            className="w-32"
          />
          ...
          <InlineInput
            value={exec.year}
            onChange={(v) => update("fiClientRegistration.creditFacility.execution.year", v)}
            placeholder="Year"
            disabled={busy}
            className="w-24"
          />
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <InlineInput
            ...
            onChange={(v) => update("fiClientRegistration.creditFacility.execution.witness1.name", v)}
          ...
          <InlineInput
            ...
            onChange={(v) => update("fiClientRegistration.creditFacility.execution.witness1.nic", v)}
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <InlineInput
            ...
            onChange={(v) => update("fiClientRegistration.creditFacility.execution.witness2.name", v)}
          ...
          <InlineInput
            ...
            onChange={(v) => update("fiClientRegistration.creditFacility.execution.witness2.nic", v)}
            placeholder="National ID Number"
            disabled={busy}
          />
        ...
        {/* <label className="mt-8 flex items-center gap-3 rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4">
          <input
            type="checkbox"
            checked={!!cf.accepted}
            onChange={(e) => update("fiClientRegistration.creditFacility.accepted", e.target.checked)}
            disabled={busy}
          />
