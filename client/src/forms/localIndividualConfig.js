...
export const localIndividualSteps = [
  // ✅ Local → Individual is a single, clean form (no stepper/progress UI).
...
export const localIndividualEmpty = {
  ...
  // ✅ AGREEMENT - CREDIT FACILITY (added as a main section in the Local Individual single-page form)
  // Kept at the root level to match the existing CreditFacilityAgreementLocalIndividual component
  // and the server-side formKey pruning (local_individual allows "creditFacility").
  creditFacility: {
    date: { day: "", month: "", year: "" },
    client: {
      name: "",
  ...
  // ✅ SCHEDULE 1 (Declaration) - added after Agreement - Credit Facility
  schedule1: {
    authorizedPersonFullName: "",
    clientNames: "",
    signedBy: "",
    stockbrokerFirm: "Asha Securities Ltd",
    name: "",
    designation: "",
    date: "",
    nicNo: "",
  ...
  // ✅ SCHEDULE 2 (Acknowledgement) - added after Schedule 1
  schedule2: {
    party1Name: "",
    party1Id: "",
    party2Name: "",
    ...
    signatureName: "",
    date: "",
    settlementOption: "", // hold_credit | settle_due | normal
  },
};