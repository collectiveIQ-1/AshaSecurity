...
export default function ForeignIndividualSchedule1({ form, update, busy }) {
  const s1 = form?.fiClientRegistration?.schedule1 || {};
  const set = (path, v) => update(`fiClientRegistration.schedule1.${path}`, v);
