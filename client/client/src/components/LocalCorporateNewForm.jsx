...
export default function LocalCorporateNewForm({
  form,
  update,
  busy,
  ...
  setLcBankStatement,
  lcBoardResolution,
  setLcBoardResolution,
  lcMemorandumArticles,
  setLcMemorandumArticles,
  lcIncorporationCertificate,
  setLcIncorporationCertificate,
  lcDirector1Sig,
  setLcDirector1Sig,
  lcDirector2Sig,
  setLcDirector2Sig,
  ...
  setLcAuthorizerSignature,
  lcStockbrokerFirmSignature,
  setLcStockbrokerFirmSignature,
  lcWitness1Signature,
  setLcWitness1Signature,
  lcWitness2Signature,
  setLcWitness2Signature,
  lcPrincipalApplicantSignature,
  setLcPrincipalApplicantSignature,
  lcJointApplicantSignature,
  setLcJointApplicantSignature,
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 gap-4">
          <Field label="Name of Company">
            <Input
              ...
              path="clientRegistration.companyName"
              onChange={(e) =>
          ...
          <Field label="Tel No(s)">
            <PhoneInput
              ...
              onChange={(v) => update("clientRegistration.telNos", v)}
          ...
          <Field label="Fax No(s)">
            <Input
              ...
              onChange={(e) =>
                update("clientRegistration.faxNos", e.target.value)
              }
          ...
          <Field label="Email">
            <Input
              ...
              onChange={(e) =>
                update("clientRegistration.email", e.target.value)
              }
          ...
          <Field label="Website">
            <Input
              ...
              onChange={(e) =>
                update("clientRegistration.website", e.target.value)
              }
          ...
          <Field label="Registered Address">
            <Input
              ...
              path="clientRegistration.registeredAddress"
              onChange={(e) =>
          ...
          <Field label="Correspondence Address">
            <Input
              ...
              path="clientRegistration.correspondenceAddress"
              onChange={(e) =>
                update(
                  "clientRegistration.correspondenceAddress",
                  e.target.value,
                )
              }
          ...
          <Field label="Business Registration No.">
            <Input
              ...
              path="clientRegistration.businessRegNo"
              onChange={(e) =>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Date of Incorporation">
              <Input
                ...
                path="clientRegistration.dateOfIncorporation"
                onChange={(e) =>
                  update(
                    "clientRegistration.dateOfIncorporation",
                    e.target.value,
                  )
                }
              />
          ...
          {/* <div className="grid grid-cols-1 gap-4">
            <Field label="Place of Incorporation">
              <Input
                ...
                path="clientRegistration.placeOfIncorporation"
                onChange={(e) => update("clientRegistration.placeOfIncorporation", e.target.value)}
          ...
          <Field label="Nature of Business">
            <Input
              ...
              path="clientRegistration.natureOfBusiness"
              onChange={(e) =>
      ...
      <Card title="Bank Details">
        <div className="grid grid-cols-1 gap-4">
          <Field label="Bank">
            <Input
              value={bd.bank}
              path="clientRegistration.bankDetails.bank"
              onChange={(e) =>
                update("clientRegistration.bankDetails.bank", e.target.value)
              }
            />
          </Field>
          <Field label="Branch">
            <Input
              value={bd.branch}
              path="clientRegistration.bankDetails.branch"
              onChange={(e) =>
                update("clientRegistration.bankDetails.branch", e.target.value)
              }
            />
          </Field>
          <Field label="Type of Account">
            <Input
              ...
              path="clientRegistration.bankDetails.accountType"
              onChange={(e) =>
                update(
                  "clientRegistration.bankDetails.accountType",
                  e.target.value,
                )
              }
            />
          ...
          <Field label="Account No.">
            <Input
              value={bd.accountNo}
              path="clientRegistration.bankDetails.accountNo"
              onChange={(e) =>
                update(
                  "clientRegistration.bankDetails.accountNo",
                  e.target.value,
                )
              }
            />
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <Field label="Place of Incorporation">
                <Input
                  ...
                  onChange={(e) =>
                    update(
                      "clientRegistration.placeOfIncorporation",
                      e.target.value,
                    )
                  }
                  placeholder="Enter place"
              ...
              <Field label="Registered Address">
                <Input
                  ...
                  onChange={(e) =>
                    update(
                      "clientRegistration.registeredAddress",
                      e.target.value,
                    )
                  }
                  placeholder="Enter Registered Address"
            ...
            {/* <div className="grid grid-cols-1 gap-4">
              <Field label="A list of up to ten major share holders (if there any)">
                <TextArea
                  value={cr.para1}
                  path="clientRegistration.para1"
                  onChange={(e) => update("clientRegistration.para1", e.target.value)}
              ...
              <Field label="A para2">
                <TextArea
                  value={cr.para2}
                  path="clientRegistration.para2"
                  onChange={(e) => update("clientRegistration.para2", e.target.value)}
                  placeholder="Enter details"
                />
              </Field>
            </div> */}
            ...
            <Field label="Present broker(s) if any">
              <Input
                ...
                path="clientRegistration.presentBrokers"
                onChange={(e) =>
              ...
              <div className="mt-2 grid grid-cols-1 gap-2">
                <label className="flex items-start gap-3 rounded-2xl border border-zinc-200 bg-white/60 px-3 py-2 text-sm text-zinc-700 shadow-soft dark:border-zinc-800 dark:bg-zinc-950/25 dark:text-zinc-200">
                  <input
                    ...
                    onChange={(e) =>
                      update(
                        "clientRegistration.mainProcess.holdForCollections",
                        e.target.checked,
                      )
                    }
                    disabled={busy}
                ...
                <label className="flex items-start gap-3 rounded-2xl border border-zinc-200 bg-white/60 px-3 py-2 text-sm text-zinc-700 shadow-soft dark:border-zinc-800 dark:bg-zinc-950/25 dark:text-zinc-200">
                  <input
                    ...
                    onChange={(e) =>
                      update(
                        "clientRegistration.mainProcess.chequesKeptAtOffice",
                        e.target.checked,
                      )
                    }
                    disabled={busy}
            ...
            <div className="grid grid-cols-1 gap-4">
              <Field label="Correspondences Contact">
                <Input
                  value={cc.name}
                  path="clientRegistration.correspondenceContact.name"
                  onChange={(e) =>
                    update(
                      "clientRegistration.correspondenceContact.name",
                      e.target.value,
                    )
                  }
                  placeholder=""
              ...
              <Field label="Tel No">
                <PhoneInput
                  value={cc.telNo}
                  path="clientRegistration.correspondenceContact.telNo"
                  onChange={(v) =>
                    update("clientRegistration.correspondenceContact.telNo", v)
                  }
                  placeholder="Enter Telephone Number"
                />
              </Field>
              <Field label="Fax No">
                <Input
                  value={cc.faxNo}
                  path="clientRegistration.correspondenceContact.faxNo"
                  onChange={(e) =>
                    update(
                      "clientRegistration.correspondenceContact.faxNo",
                      e.target.value,
                    )
                  }
                  placeholder=""
        ...
        {/* <div className="grid grid-cols-1 gap-4">
          <FileUpload label="Copy Bank Statement" value={lcBankStatement} setValue={setLcBankStatement} disabled={busy} />
        </div> */}
          ...
          <div className="grid grid-cols-1 gap-4">
            <Field label="Application Received on">
              <Input
                ...
                onChange={(e) =>
                  update(
                    "clientRegistration.officeUseOnly.applicationReceivedOn",
                    e.target.value,
                  )
                }
              />
            ...
            <Field label="Date">
              <Input
                type="date"
                value={ou.date}
                path="clientRegistration.officeUseOnly.date"
                onChange={(e) =>
                  update(
                    "clientRegistration.officeUseOnly.date",
                    e.target.value,
                  )
                }
              />
            ...
            <Field label="Advisor’s Code">
              <Input
                ...
                path="clientRegistration.officeUseOnly.advisorsCode"
                onChange={(e) =>
                  update(
                    "clientRegistration.officeUseOnly.advisorsCode",
                    e.target.value,
                  )
                }
              />
          ...
          {/* <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="(Investment Advisor) Name">
              <Input
                ...
                path="clientRegistration.staffDeclaration.investmentAdvisorName"
                onChange={(e) => update("clientRegistration.staffDeclaration.investmentAdvisorName", e.target.value)}
              />
            </Field>
            <Field label="Risk disclosure acknowledged">
              <label className="flex items-center gap-3 rounded-2xl border border-zinc-200 bg-white/60 px-3 py-2 text-sm text-zinc-700 shadow-soft dark:border-zinc-800 dark:bg-zinc-950/30 dark:text-zinc-200">
                <input
                  ...
                  onChange={(e) => update("clientRegistration.declaration.agreedToRiskDisclosure", e.target.checked)}
                  disabled={busy}
                />
          ...
          <div className="grid grid-cols-1 gap-4">
            <Field label="Client Introduced by">
              <Input
                ...
                path="clientRegistration.clientIntroducedBy"
                onChange={(e) => update("clientRegistration.clientIntroducedBy", e.target.value)}
                placeholder=""
              />
            </Field>
          </div>
      ...
      >
        <div className="grid grid-cols-1 gap-4">
          <FileUpload label="Board Resolution" value={lcBoardResolution} setValue={setLcBoardResolution} disabled={busy} />
          <Field label="Board Resolution Details / Authorized persons (names & designations)">
            <Input
              value={cr.boardResolutionDetails}
              path="clientRegistration.boardResolutionDetails"
              onChange={(e) => update("clientRegistration.boardResolutionDetails", e.target.value)}
              placeholder="Enter details"
            />
          </Field>
          <Field label="Major Shareholders (up to ten)">
            <Input
              ...
              path="clientRegistration.majorShareholders"
              onChange={(e) => update("clientRegistration.majorShareholders", e.target.value)}
          ...
          <div className="rounded-3xl border border-zinc-200 bg-white/60 p-4 shadow-soft backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/30">
            ...
            <div className="grid grid-cols-1 gap-4">
              <Field label="Declaration by the staff,">
                <Input
                  value={sd.staffName}
                  path="clientRegistration.staffDeclaration.staffName"
                  onChange={(e) =>
                    update(
                      "clientRegistration.staffDeclaration.staffName",
                      e.target.value,
                    )
                  }
              ...
              <div className="mt-2 text-sm leading-relaxed text-zinc-700 dark:text-zinc-200">
                <div className="flex flex-col gap-2">
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 items-end">
                    ...
                    <div className="sm:col-span-10">
                      <LineInput
                        value={decl.weName}
                        path="clientRegistration.declaration.weName"
                        onChange={(e) =>
                          update(
                            "clientRegistration.declaration.weName",
                            e.target.value,
                          )
                        }
                        placeholder=""
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 items-end">
                    ...
                    <div className="sm:col-span-7">
                      <LineInput
                        value={decl.weBrNo}
                        path="clientRegistration.declaration.weBrNo"
                        onChange={(e) =>
                          update(
                            "clientRegistration.declaration.weBrNo",
                            e.target.value,
                          )
                        }
                        placeholder=""
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 items-end">
                    ...
                    <div className="sm:col-span-11">
                      <LineInput
                        value={decl.weOf}
                        path="clientRegistration.declaration.weOf"
                        onChange={(e) =>
                          update(
                            "clientRegistration.declaration.weOf",
                            e.target.value,
                          )
                        }
                        placeholder=""
                ...
                <div className="grid grid-cols-1 gap-4">
                  <FileUpload
                    ...
                    path="lcMemorandumArticles"
                    value={lcMemorandumArticles}
                    setValue={setLcMemorandumArticles}
                    disabled={busy}
                  />
                  <FileUpload
                    label="Upload the incorporated certificate"
                    path="lcIncorporationCertificate"
                    value={lcIncorporationCertificate}
                    setValue={setLcIncorporationCertificate}
                    disabled={busy}
                  />
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <Field label="Nature of the business">
                        <Input
                          ...
                          path="clientRegistration.kycProfile.natureOfBusiness"
                          onChange={(e) =>
                            update(
                              "clientRegistration.kycProfile.natureOfBusiness",
                              e.target.value,
                            )
                          }
                          placeholder="Enter Nature of Business"
                          ...
                          {[
                            ...
                            >
                              <input
                                ...
                                onChange={() =>
                                  update(
                                    "clientRegistration.kycProfile.expectedInvestmentPerAnnum",
                                    opt.v,
                                  )
                                }
                                disabled={busy}
                                ...
                                <label className="flex items-start gap-3 rounded-2xl border border-zinc-200 bg-white/60 px-3 py-2 text-sm text-zinc-700 shadow-soft backdrop-blur transition hover:bg-white/80 dark:border-zinc-800 dark:bg-zinc-950/25 dark:text-zinc-200">
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      update("clientRegistration.kycProfile", {
                                        ...kyc,
                                        sourceOfFunds: next,
                                        sourceOfFundsOther:
                                          isOthers && !isChecked
                                ...
                                {isOthers && checked ? (
                                  <div className="mt-2 rounded-2xl border border-zinc-200 bg-white/80 p-3 shadow-soft backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/25">
                                    ...
                                    <Input
                                      ...
                                      path="clientRegistration.kycProfile.sourceOfFundsOther"
                                      onChange={(e) =>
                                        update(
                                          "clientRegistration.kycProfile.sourceOfFundsOther",
                                          e.target.value,
                                        )
                                      }
                          ...
                          {["Yes", "No"].map((v) => (
                            ...
                            >
                              <input
                                ...
                                onChange={() =>
                                  update(
                                    "clientRegistration.kycProfile.fatcaUSPerson",
                                    v,
                                  )
                                }
                                disabled={busy}
                      ...
                      <div className="rounded-3xl border border-zinc-200 bg-white/55 p-4 shadow-soft backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/25">
                          ...
                          {["Yes", "No"].map((v) => (
                            ...
                            >
                              <input
                                ...
                                checked={kyc.pep === v}
                                onChange={() =>
                                  update("clientRegistration.kycProfile.pep", v)
                                }
                                disabled={busy}
                              />
                              <span>{v}</span>
                        ...
                        <div className="mt-2">
                          <TextArea
                            ...
                            path="clientRegistration.kycProfile.pepDetails"
                            onChange={(e) =>
                              update(
                                "clientRegistration.kycProfile.pepDetails",
                                e.target.value,
                              )
                            }
                      ...
                      <Field label="Any other connected Businesses/ Professional activities">
                        <TextArea
                          ...
                          path="clientRegistration.kycProfile.otherConnectedBusinesses"
                          onChange={(e) =>
                            update(
                              "clientRegistration.kycProfile.otherConnectedBusinesses",
                              e.target.value,
                            )
                          }
                          placeholder=""
                      ...
                      <div className="rounded-3xl border border-zinc-200 bg-white/55 p-4 shadow-soft backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/25">
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-4">
                          <Input
                            value={ap.name}
                            path="clientRegistration.kycProfile.authorizedPerson.name"
                            onChange={(e) =>
                              update(
                                "clientRegistration.kycProfile.authorizedPerson.name",
                                e.target.value,
                              )
                            }
                            placeholder="Name"
                          ...
                          <Input
                            ...
                            path="clientRegistration.kycProfile.authorizedPerson.designation"
                            onChange={(e) =>
                              update(
                                "clientRegistration.kycProfile.authorizedPerson.designation",
                                e.target.value,
                              )
                            }
                          ...
                          <PhoneInput
                            value={ap.telephone}
                            path="clientRegistration.kycProfile.authorizedPerson.telephone"
                            onChange={(v) =>
                              update(
                                "clientRegistration.kycProfile.authorizedPerson.telephone",
                                v,
                              )
                            }
                          ...
                          <Input
                            value={ap.fax}
                            path="clientRegistration.kycProfile.authorizedPerson.fax"
                            onChange={(e) =>
                              update(
                                "clientRegistration.kycProfile.authorizedPerson.fax",
                                e.target.value,
                              )
                            }
                            placeholder="Fax"
                          ...
                          <PhoneInput
                            value={ap.mobile}
                            path="clientRegistration.kycProfile.authorizedPerson.mobile"
                            onChange={(v) =>
                              update(
                                "clientRegistration.kycProfile.authorizedPerson.mobile",
                                v,
                              )
                            }
                            placeholder="Mobile"
                          ...
                          <Input
                            value={ap.email}
                            path="clientRegistration.kycProfile.authorizedPerson.email"
                            onChange={(e) =>
                              update(
                                "clientRegistration.kycProfile.authorizedPerson.email",
                                e.target.value,
                              )
                            }
                            placeholder="Email"
                      ...
                      <Field label="Other remarks / notes (if any)">
                        <TextArea
                          ...
                          path="clientRegistration.kycProfile.otherRemarks"
                          onChange={(e) =>
                            update(
                              "clientRegistration.kycProfile.otherRemarks",
                              e.target.value,
                            )
                          }
                      ...
                      <div className="mt-8">
                        <Card title="CLIENT AGREEMENT">
                          {(() => {
                            ...
                            const setDate = (k, v) =>
                              update(
                                `clientRegistration.clientAgreement.date.${k}`,
                                ...
                                <div className="rounded-2xl border border-zinc-200 bg-zinc-50/80 p-4 dark:border-zinc-800 dark:bg-zinc-900/40">
                                  <div className="flex flex-wrap items-center gap-2 text-sm text-zinc-800 dark:text-zinc-200">
                                    ...
                                    <AgreementInput
                                      ...
                                      placeholder="DD"
                                      value={date.day || ""}
                                      path="clientRegistration.clientAgreement.date.day"
                                      inputMode="numeric"
                                      maxLength={2}
                                      onChange={(e) =>
                                    ...
                                    <AgreementInput
                                      ...
                                      placeholder="MM"
                                      value={date.month || ""}
                                      path="clientRegistration.clientAgreement.date.month"
                                      inputMode="numeric"
                                      maxLength={2}
                                      onChange={(e) =>
                                    ...
                                    <AgreementInput
                                      ...
                                      placeholder="YYYY"
                                      value={date.year || ""}
                                      path="clientRegistration.clientAgreement.date.year"
                                      inputMode="numeric"
                                      maxLength={4}
                                      onChange={(e) =>
                                ...
                                <div className="space-y-4">
                                  {partyMeta.map(
                                    ({
                                      ...
                                      const partyPath = `clientRegistration.clientAgreement.parties.${idx}`;
                                      return (
                                        <div
                                          key={idx}
                      ...
                      <div className="mt-8">
                        <CreditFacilityAgreementLocalCorporate
                          ...
                          pathPrefix="clientRegistration.creditFacility"
                          clientDefaults={{
                            name: cr.companyName,
                            ...
                            <div className="mt-5 grid grid-cols-1 gap-3">
                              <label className="flex items-start gap-3 rounded-3xl border border-zinc-200 bg-white/80 px-4 py-3 text-sm text-zinc-700 shadow-soft transition hover:border-sky-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950/30 dark:text-zinc-200 dark:hover:border-sky-800">
                                <input
                                  type="checkbox"
                                  checked={
                                    !!form?.clientRegistration?.privacyConsent
                                      ?.consentDataProcessing
                                  }
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.privacyConsent.consentDataProcessing",
                                      e.target.checked,
                                    )
                                  }
                                  disabled={busy}
                              ...
                              <label className="flex items-start gap-3 rounded-3xl border border-zinc-200 bg-white/80 px-4 py-3 text-sm text-zinc-700 shadow-soft transition hover:border-sky-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950/30 dark:text-zinc-200 dark:hover:border-sky-800">
                                <input
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.privacyConsent.consentThirdPartySharing",
                                      e.target.checked,
                                    )
                                  }
                                  disabled={busy}
                              ...
                              <label className="flex items-start gap-3 rounded-3xl border border-zinc-200 bg-white/80 px-4 py-3 text-sm text-zinc-700 shadow-soft transition hover:border-sky-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950/30 dark:text-zinc-200 dark:hover:border-sky-800">
                                <input
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.privacyConsent.consentMarketing",
                                      e.target.checked,
                                    )
                                  }
                                  disabled={busy}
                          ...
                          <div className="text-sm leading-8 text-zinc-800 dark:text-zinc-200/90">
                            ...
                            <span className="mx-2 inline-block w-full max-w-[18rem] align-middle">
                              <LineInput
                                ...
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.schedule1.employeeName",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                                path="clientRegistration.schedule1.employeeName"
                              />
                            </span>
                            <span>
                            ...
                            <span className="mx-2 inline-block w-full max-w-[20rem] align-middle">
                              <LineInput
                                ...
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.schedule1.clientNames",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                                path="clientRegistration.schedule1.clientNames"
                              />
                            </span>
                            <span>
                          ...
                          <div className="mt-6 rounded-2xl border border-zinc-200 bg-white/70 p-4 dark:border-zinc-800 dark:bg-zinc-950/25">
                            ...
                            <div className="mt-3">
                              <LineInput
                                ...
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.schedule1.signedBy",
                                    e.target.value,
                                  )
                                }
                                placeholder="Enter signed by"
                                path="clientRegistration.schedule1.signedBy"
                              />
                            </div>
                            ...
                            <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                              <div>
                                ...
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule1.name",
                                      e.target.value,
                                    )
                                  }
                                  placeholder="Enter name"
                                  path="clientRegistration.schedule1.name"
                                />
                              </div>
                              <div>
                                <div className="text-xs font-semibold uppercase tracking-wide text-zinc-700 dark:text-zinc-300">
                                ...
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule1.designation",
                                      e.target.value,
                                    )
                                  }
                                  placeholder="Enter designation"
                                  path="clientRegistration.schedule1.designation"
                                />
                              </div>
                              <div>
                                <div className="text-xs font-semibold uppercase tracking-wide text-zinc-700 dark:text-zinc-300">
                                ...
                                <LineDateInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule1.date",
                                      e.target.value,
                                    )
                                  }
                                  placeholder="DD / MM / YYYY"
                                  path="clientRegistration.schedule1.date"
                                />
                              </div>
                              <div>
                                <div className="text-xs font-semibold uppercase tracking-wide text-zinc-700 dark:text-zinc-300">
                                ...
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule1.nicNo",
                                      e.target.value,
                                    )
                                  }
                                  placeholder="Enter NIC number"
                                  path="clientRegistration.schedule1.nicNo"
                                />
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="mt-4 rounded-3xl border border-zinc-200 bg-white/75 p-5 text-[13px] leading-7 text-zinc-700 shadow-soft dark:border-zinc-800 dark:bg-zinc-950/35 dark:text-zinc-300">
                            ...
                            <div>
                              ...
                              <span className="mx-2 inline-block w-full max-w-[17rem] align-middle">
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule2.party1Name",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                                  path="clientRegistration.schedule2.party1Name"
                                />
                              </span>
                              <span>
                              ...
                              <span className="mx-2 inline-block w-full max-w-[14rem] align-middle">
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule2.party1Id",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                                  path="clientRegistration.schedule2.party1Id"
                                />
                              </span>
                              <span>of</span>
                              <span className="mx-2 inline-block w-full max-w-[18rem] align-middle">
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule2.party1Address",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                                  path="clientRegistration.schedule2.party1Address"
                                />
                              </span>
                              <span>],</span>
                            </div>
                            ...
                            <div>
                              ...
                              <span className="mx-2 inline-block w-full max-w-[17rem] align-middle">
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule2.party2Name",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                                  path="clientRegistration.schedule2.party2Name"
                                />
                              </span>
                              <span>
                                [bearing National Identity Card No./Company
                              ...
                              <span className="mx-2 inline-block w-full max-w-[14rem] align-middle">
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule2.party2Id",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                                  path="clientRegistration.schedule2.party2Id"
                                />
                              </span>
                              <span>of</span>
                              <span className="mx-2 inline-block w-full max-w-[18rem] align-middle">
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule2.party2Address",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                                  path="clientRegistration.schedule2.party2Address"
                                />
                              </span>
                              <span>] and,</span>
                            </div>
                            ...
                            <div>
                              ...
                              <span className="mx-2 inline-block w-full max-w-[17rem] align-middle">
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule2.party3Name",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                                  path="clientRegistration.schedule2.party3Name"
                                />
                              </span>
                              <span>
                                [bearing National Identity Card No./Company
                              ...
                              <span className="mx-2 inline-block w-full max-w-[14rem] align-middle">
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule2.party3Id",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                                  path="clientRegistration.schedule2.party3Id"
                                />
                              </span>
                              <span>of</span>
                              <span className="mx-2 inline-block w-full max-w-[18rem] align-middle">
                                <LineInput
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.schedule2.party3Address",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                                  path="clientRegistration.schedule2.party3Address"
                                />
                              </span>
                              <span>],</span>
                            </div>
                          ...
                          <div className="mt-5 text-sm leading-8 text-zinc-800 dark:text-zinc-200/90">
                            ...
                            <span className="mx-2 inline-block w-full max-w-[18rem] align-middle">
                              <LineInput
                                ...
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.schedule2.explainedBy",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                                path="clientRegistration.schedule2.explainedBy"
                              />
                            </span>
                            <span>
                              an employee of Asha Securities Ltd
                          ...
                          <div className="mt-6 max-w-sm">
                            ...
                            <LineDateInput
                              ...
                              onChange={(e) =>
                                update(
                                  "clientRegistration.schedule2.date",
                                  e.target.value,
                                )
                              }
                              placeholder="DD / MM / YYYY"
                              path="clientRegistration.schedule2.date"
                            />
                          </div>
                        </div>
                      </Card>
                        ...
                        <div className="rounded-[28px] border border-zinc-200 bg-gradient-to-br from-white via-white to-zinc-50 p-5 shadow-soft dark:border-zinc-800 dark:from-zinc-950/60 dark:via-zinc-950/45 dark:to-zinc-900/30">
                          ...
                          <div className="sm:col-span-2">
                            <Field label="Name of Natural Person Opening Account:">
                              <Input
                                ...
                                path="clientRegistration.beneficialOwnershipForm.customerIdentification.naturalPersonName"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.customerIdentification.naturalPersonName",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="Designation of Natural Person Opening Account:">
                              <Input
                                ...
                                path="clientRegistration.beneficialOwnershipForm.customerIdentification.naturalPersonDesignation"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.customerIdentification.naturalPersonDesignation",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="Name of Legal Person for Which the Account is Being Opened:">
                              <Input
                                ...
                                path="clientRegistration.beneficialOwnershipForm.customerIdentification.legalPersonName"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.customerIdentification.legalPersonName",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="Reg. No of Legal Person for Which the Account is Being Opened:">
                              <Input
                                ...
                                path="clientRegistration.beneficialOwnershipForm.customerIdentification.legalPersonRegNo"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.customerIdentification.legalPersonRegNo",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <div className="sm:col-span-2">
                              <Field label="Address of Legal Person for Which the Account is Being Opened:">
                                <Input
                                  ...
                                  path="clientRegistration.beneficialOwnershipForm.customerIdentification.legalPersonAddress"
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.beneficialOwnershipForm.customerIdentification.legalPersonAddress",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                            ...
                            <Field label="Name of Legal Arrangement for Which the Account is Being Opened:">
                              <Input
                                ...
                                path="clientRegistration.beneficialOwnershipForm.customerIdentification.arrangementName"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.customerIdentification.arrangementName",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="Deed No of Legal Arrangement for Which the Account is Being Opened:">
                              <Input
                                ...
                                path="clientRegistration.beneficialOwnershipForm.customerIdentification.arrangementDeedNo"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.customerIdentification.arrangementDeedNo",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="Trustee of Legal Arrangement for Which the Account is Being Opened:">
                              <Input
                                ...
                                path="clientRegistration.beneficialOwnershipForm.customerIdentification.arrangementTrustee"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.customerIdentification.arrangementTrustee",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="Address of Legal Arrangement for Which the Account is Being Opened:">
                              <Input
                                ...
                                path="clientRegistration.beneficialOwnershipForm.customerIdentification.arrangementAddress"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.customerIdentification.arrangementAddress",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                          ...
                          <div className="grid grid-cols-1 gap-3">
                            <TickBox
                              ...
                              onChange={(e) =>
                                update(
                                  "clientRegistration.beneficialOwnershipForm.declaration.isBeneficialOwner",
                                  e.target.checked,
                                )
                              }
                              path="clientRegistration.beneficialOwnershipForm.declaration.isBeneficialOwner"
                            ...
                            <TickBox
                              ...
                              onChange={(e) =>
                                update(
                                  "clientRegistration.beneficialOwnershipForm.declaration.isNotBeneficialOwner",
                                  e.target.checked,
                                )
                              }
                              path="clientRegistration.beneficialOwnershipForm.declaration.isNotBeneficialOwner"
                              ...
                              >
                                ...
                                <div className="xl:col-span-2">
                                  <CompactField
                                    ...
                                    onChange={(e) =>
                                      update(
                                        `clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.name`,
                                        e.target.value,
                                      )
                                    }
                                    placeholder=""
                                    path={`clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.name`}
                                  />
                                  <br></br>
                                  <CompactField
                                    ...
                                    onChange={(e) =>
                                      update(
                                        `clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.nicOrPassport`,
                                        e.target.value,
                                      )
                                    }
                                    placeholder=""
                                    path={`clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.nicOrPassport`}
                                  />
                                  <br></br>
                                  <CompactField
                                    label="Date of Birth"
                                    ...
                                    onChange={(e) =>
                                      update(
                                        `clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.dob`,
                                        e.target.value,
                                      )
                                    }
                                    placeholder="DD / MM / YYYY"
                                    path={`clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.dob`}
                                  />
                                  <br></br>
                                  <div className="xl:col-span-2">
                                    <CompactField
                                      ...
                                      onChange={(e) =>
                                        update(
                                          `clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.currentAddress`,
                                          e.target.value,
                                        )
                                      }
                                      placeholder=""
                                      path={`clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.currentAddress`}
                                    />
                                    <br></br>
                                  </div>
                                  <CompactField
                                    ...
                                    onChange={(e) =>
                                      update(
                                        `clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.sourceOfBeneficialOwnership`,
                                        e.target.value,
                                      )
                                    }
                                    placeholder=""
                                    path={`clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.sourceOfBeneficialOwnership`}
                                  />
                                  <br></br>
                                  <label className="flex items-center gap-3 rounded-2xl border border-zinc-200 px-4 py-3 text-sm text-zinc-700 dark:border-zinc-800 dark:text-zinc-200">
                                    <input
                                      ...
                                      onChange={(e) =>
                                        update(
                                          `clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.pep`,
                                          e.target.checked,
                                        )
                                      }
                                      data-path={`clientRegistration.beneficialOwnershipForm.beneficialOwners.${index}.pep`}
                          ...
                          <div className="xl:col-span-2">
                            <Field label="Name">
                              <Input
                                value={boAuth.name}
                                path="clientRegistration.beneficialOwnershipForm.authorizedCustomer.name"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.authorizedCustomer.name",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="NIC / Passport">
                              <Input
                                ...
                                path="clientRegistration.beneficialOwnershipForm.authorizedCustomer.nicOrPassport"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.authorizedCustomer.nicOrPassport",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="Date of Birth">
                              <Input
                                type="date"
                                value={boAuth.dob}
                                path="clientRegistration.beneficialOwnershipForm.authorizedCustomer.dob"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.authorizedCustomer.dob",
                                    e.target.value,
                                  )
                                }
                                placeholder="DD / MM / YYYY"
                            ...
                            <div className="sm:col-span-2">
                              <Field label="Verification of Beneficial Ownership">
                                <TextArea
                                  ...
                                  path="clientRegistration.beneficialOwnershipForm.authorizedCustomer.verificationText"
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.beneficialOwnershipForm.authorizedCustomer.verificationText",
                                      e.target.value,
                                    )
                                  }
                                  placeholder=""
                          ...
                          <div className="xl:col-span-2">
                            <Field label="Name">
                              <Input
                                value={boAfi.name}
                                path="clientRegistration.beneficialOwnershipForm.afiOfficial.name"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.afiOfficial.name",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="Title">
                              <Input
                                value={boAfi.title}
                                path="clientRegistration.beneficialOwnershipForm.afiOfficial.title"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.afiOfficial.title",
                                    e.target.value,
                                  )
                                }
                                placeholder=""
                            ...
                            <Field label="Date">
                              <Input
                                type="date"
                                value={boAfi.date}
                                path="clientRegistration.beneficialOwnershipForm.afiOfficial.date"
                                onChange={(e) =>
                                  update(
                                    "clientRegistration.beneficialOwnershipForm.afiOfficial.date",
                                    e.target.value,
                                  )
                                }
                                placeholder="DD / MM / YYYY"
                          ...
                          <div className="rounded-[26px] border border-zinc-200 bg-white/90 p-5 shadow-soft dark:border-zinc-800 dark:bg-zinc-950/35">
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                              ...
                              <Field label="Date">
                                <Input
                                  value={boPay.date}
                                  path="clientRegistration.beneficialOwnershipForm.paymentAuthorization.date"
                                  onChange={(e) => update("clientRegistration.beneficialOwnershipForm.paymentAuthorization.date", e.target.value)}
                                  placeholder="DD / MM / YYYY"
                                />
                              </Field>
                            </div> */}
                            ...
                            <div className="mt-5 space-y-4">
                              <label className="flex items-start gap-4 rounded-2xl border border-zinc-200 bg-zinc-50/70 px-4 py-4 text-sm text-zinc-800 transition hover:border-zinc-300 hover:bg-white dark:border-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-200 dark:hover:border-zinc-700 dark:hover:bg-zinc-900/50">
                                <input
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.beneficialOwnershipForm.paymentAuthorization.holdCreditBalance",
                                      e.target.checked,
                                    )
                                  }
                                  data-path="clientRegistration.beneficialOwnershipForm.paymentAuthorization.holdCreditBalance"
                              ...
                              <label className="flex items-start gap-4 rounded-2xl border border-zinc-200 bg-zinc-50/70 px-4 py-4 text-sm text-zinc-800 transition hover:border-zinc-300 hover:bg-white dark:border-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-200 dark:hover:border-zinc-700 dark:hover:bg-zinc-900/50">
                                <input
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.beneficialOwnershipForm.paymentAuthorization.settleOnDueDate",
                                      e.target.checked,
                                    )
                                  }
                                  data-path="clientRegistration.beneficialOwnershipForm.paymentAuthorization.settleOnDueDate"
                                  className="mt-1 h-5 w-5 rounded border-zinc-400"
                                />
                                <span>
                              ...
                              <label className="flex items-start gap-4 rounded-2xl border border-zinc-200 bg-zinc-50/70 px-4 py-4 text-sm text-zinc-800 transition hover:border-zinc-300 hover:bg-white dark:border-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-200 dark:hover:border-zinc-700 dark:hover:bg-zinc-900/50">
                                <input
                                  ...
                                  onChange={(e) =>
                                    update(
                                      "clientRegistration.beneficialOwnershipForm.paymentAuthorization.normalSettlement",
                                      e.target.checked,
                                    )
                                  }
                                  data-path="clientRegistration.beneficialOwnershipForm.paymentAuthorization.normalSettlement"
                                  className="mt-1 h-5 w-5 rounded border-zinc-400"
                                />
                                <span>
                          ...
                          <div className="mt-5 grid grid-cols-1 gap-4 xl:grid-cols-2">
                            ...
                            <UploadSignatureCard title="Upload Signature of Agent">
                              <FileUpload
                                ...
                                accept="image/*,.pdf"
                                file={lcAgentSignature}
                                setFile={setLcAgentSignature}
                                path="lcAgentSignature"
                                hint={busy ? "" : "Upload signature file"}
                              />
                            </UploadSignatureCard>
                            ...
                            <UploadSignatureCard title="Upload Signature of Authorizer">
                              <FileUpload
                                ...
                                accept="image/*,.pdf"
                                file={lcAuthorizerSignature}
                                setFile={setLcAuthorizerSignature}
                                path="lcAuthorizerSignature"
                                hint={busy ? "" : "Upload signature file"}
                              />
                            </UploadSignatureCard>
                            ...
                            <UploadSignatureCard title="Upload Signature of Stockbroker Firm">
                              <FileUpload
                                ...
                                accept="image/*,.pdf"
                                file={lcStockbrokerFirmSignature}
                                setFile={setLcStockbrokerFirmSignature}
                                path="lcStockbrokerFirmSignature"
                                hint={busy ? "" : "Upload signature file"}
                              />
                            </UploadSignatureCard>
                            ...
                            <UploadSignatureCard title="Upload Signature of Witness1">
                              <FileUpload
                                ...
                                accept="image/*,.pdf"
                                file={lcWitness1Signature}
                                setFile={setLcWitness1Signature}
                                path="lcWitness1Signature"
                                hint={busy ? "" : "Upload signature file"}
                              />
                            </UploadSignatureCard>
                            ...
                            <UploadSignatureCard title="Upload Signature of Witness2">
                              <FileUpload
                                ...
                                accept="image/*,.pdf"
                                file={lcWitness2Signature}
                                setFile={setLcWitness2Signature}
                                path="lcWitness2Signature"
                                hint={busy ? "" : "Upload signature file"}
                              />
                            </UploadSignatureCard>
                            ...
                            <UploadSignatureCard title="Upload Signature of Principal Applicant">
                              <FileUpload
                                ...
                                accept="image/*,.pdf"
                                file={lcPrincipalApplicantSignature}
                                setFile={setLcPrincipalApplicantSignature}
                                path="lcPrincipalApplicantSignature"
                                hint={busy ? "" : "Upload signature file"}
                              />
                            </UploadSignatureCard>
                            ...
                            <UploadSignatureCard title="Upload Signature of Joint Applicant">
                              <FileUpload
                                ...
                                accept="image/*,.pdf"
                                file={lcJointApplicantSignature}
                                setFile={setLcJointApplicantSignature}
                                path="lcJointApplicantSignature"
                                hint={busy ? "" : "Upload signature file"}
                              />
                            </UploadSignatureCard>
                          </div>
              ...
              {/* <Field label="Date">
                <Input
                  type="date"
                  value={sd.staffDate}
                  path="clientRegistration.staffDeclaration.staffDate"
                  onChange={(e) => update("clientRegistration.staffDeclaration.staffDate", e.target.value)}
                />
              </Field> */}
              {/* <Field label="Signature / Stamp">
                <Input
                  value={sd.staffSignature}
                  path="clientRegistration.staffDeclaration.staffSignature"
                  onChange={(e) => update("clientRegistration.staffDeclaration.staffSignature", e.target.value)}
            ...
            <div className="mt-2 text-sm leading-relaxed text-zinc-700 dark:text-zinc-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 items-end">
                  ...
                  <div className="sm:col-span-10">
                    <LineInput
                      value={decl.weName}
                      path="clientRegistration.declaration.weName"
                      onChange={(e) => update("clientRegistration.declaration.weName", e.target.value)}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 items-end">
                  ...
                  <div className="sm:col-span-7">
                    <LineInput
                      value={decl.weBrNo}
                      path="clientRegistration.declaration.weBrNo"
                      onChange={(e) => update("clientRegistration.declaration.weBrNo", e.target.value)}
                      placeholder="BR No."
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 items-end">
                  ...
                  <div className="sm:col-span-11">
                    <LineInput
                      value={decl.weOf}
                      path="clientRegistration.declaration.weOf"
                      onChange={(e) => update("clientRegistration.declaration.weOf", e.target.value)}
              ...
              <label className="mt-3 flex items-start gap-3 rounded-2xl border border-zinc-200 bg-white/60 px-3 py-2 text-sm text-zinc-700 shadow-soft dark:border-zinc-800 dark:bg-zinc-950/25 dark:text-zinc-200">
                <input
                  ...
                  onChange={(e) => update("clientRegistration.declaration.agreedToUndertaking", e.target.checked)}
                  disabled={busy}
                  className="mt-1"
                />
                <span>I/We agree to the above undertaking.</span>
              </label>
            </div>
          </div> */}
        </div>
      ...
      {/* <Card title="">
        <div className="grid grid-cols-1 gap-4">
          <FileUpload label="Upload the memorandum of articles" value={lcMemorandumArticles} setValue={setLcMemorandumArticles} disabled={busy} />
          <FileUpload label="Upload the incorporated certificate" value={lcIncorporationCertificate} setValue={setLcIncorporationCertificate} disabled={busy} />
        </div>
      </Card> */}
    </>
  );
