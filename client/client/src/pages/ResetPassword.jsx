      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-10">
        <div className={cx("w-full max-w-md rounded-3xl border shadow-2xl overflow-hidden", ui.card)}>
          <div className="p-7 sm:p-8">
            <div className={cx("text-2xl font-extrabold", ui.title)}>Reset Password</div>
            <div className={cx("mt-1 text-sm", ui.muted)}>Choose a new password.</div>

            <form className="mt-6 space-y-4" onSubmit={onSubmit}>
              <div>
                <label className={cx("text-xs font-semibold", ui.muted)}>New Password</label>
              ...
              <div className="pt-2 flex items-center justify-between">
                <Link to="/signin" className={cx("text-sm", ui.link)}>← Back</Link>
